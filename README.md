...
| `/checktranslation` | ревьюер | Перевести тексты из очереди на перевод |

> Все команды работают в личных сообщениях с ботом. В групповых чатах доступен только `/leaderboard` и `/stat`.
